...
function changeIframeModel(id) {
  if (id != "a852f6a6cee64953a1bda59938029a4d") {
    $("#penthousetypeb").hide();
...
jQuery(document).ready(function ($) {
  ...
  $(".groundfloor").on({
    click: function () {
      ...
      $("#apartment_rightpanel").attr(
        "src",
        "images/updated/lower_floor_typeb.jpg"
      );
      if (
        /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
          navigator.userAgent
    ...
    click: function () {
      if (stopAnimation) {
        ...
        if (window.innerHeight < window.innerWidth) {
          $(".autostart").css(
            "background",
            "url(img/stop-button_new.svg) #ffffff 4% no-repeat padding-box"
          );
          ...
          $(".autostart").css(
            "background",
            "url(img/stop-button_new.svg) #ffffff 6% no-repeat padding-box"
          );
          $(".autostart").css("background-size", "13%");
          $(".autostart").css("color", "black");
        }
        ...
        $(".autostart").css(
          "background",
          "url(img/play.svg) #ffffff 6% no-repeat padding-box"
        );
        $(".autostart").css("background-size", "10%");
  ...
  $(".fullview").on({
    click: function () {
      SELECTED_MODEL = "a852f6a6cee64953a1bda59938029a4d";
      Configurator.showParts(1);
      Configurator.showParts(4659);
      ...
      document.getElementById("dpmenu").innerHTML = "";
      for (var key in global_dict["a852f6a6cee64953a1bda59938029a4d"]) {
        $(".dropmenu").append(
          "<a onclick= 'setDropdown(" +
            global_dict["a852f6a6cee64953a1bda59938029a4d"][key][
              "annotation_index"
            ] +
            ',"' +
            global_dict["a852f6a6cee64953a1bda59938029a4d"][key]["image_path"] +
            '","' +
            key +
            '");\' class="dropdown-item" >' +
            key +
